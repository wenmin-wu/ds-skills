...
335 个可复用技巧，覆盖 5 大领域，均从高票 Kaggle 竞赛方案中提取。每个技能是一个独立的 SKILL.md —— 可直接被 Claude Code、Cursor、Codex 或任何 AI 编程助手加载使用。
...
| **cv** (计算机视觉) | 86 | arcface-metric-learning, deepsort-majority-vote-relabel, rotation-search-point-registration, iou-weighted-assignment-metric |
| **timeseries** (时间序列) | 36 | event-anchored-frame-sync, keystroke-pause-bucket-features, burst-rle-detection, multi-gap-lag-diff-features |
