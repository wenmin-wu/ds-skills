...
505 个可复用技巧，覆盖 5 大领域，均从高票 Kaggle 竞赛方案中提取。每个技能是一个独立的 SKILL.md —— 可直接被 Claude Code、Cursor、Codex 或任何 AI 编程助手加载使用。
...
| **cv** (计算机视觉) | 165 | brovey-pansharpening, spectral-index-segmentation, mask-to-polygon-contour-hierarchy, percentile-contrast-stretch |
| **timeseries** (时间序列) | 58 | ratio-target-for-smape, expanding-window-stacking, density-to-count-roundtrip, retroactive-outlier-rescaling |
