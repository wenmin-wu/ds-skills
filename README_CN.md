...
430 个可复用技巧，覆盖 5 大领域，均从高票 Kaggle 竞赛方案中提取。每个技能是一个独立的 SKILL.md —— 可直接被 Claude Code、Cursor、Codex 或任何 AI 编程助手加载使用。
...
| **cv** (计算机视觉) | 135 | siamese-pairwise-comparison-head, lap-hard-negative-mining, batch-all-contrastive-loss, open-set-distance-cutoff |
