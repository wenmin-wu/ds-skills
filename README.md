...
330 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **cv** | 82 | arcface-metric-learning, chunked-gpu-similarity-search, dicom-hounsfield-normalization, knn-distance-threshold-matching |
| **timeseries** | 35 | keystroke-pause-bucket-features, burst-rle-detection, multi-gap-lag-diff-features, gaussian-log-likelihood-metric |
