...
510 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
|--------|-------|---------|
| **tabular** | 113 | simulated-annealing-multi-operator, strtree-spatial-index-collision, convex-hull-bbox-rotation, squeeze-compact-local-search |
...
| **timeseries** | 58 | ratio-target-for-smape, density-to-count-roundtrip, expanding-window-stacking, retroactive-outlier-rescaling |
