...
465 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
|--------|-------|---------|
| **tabular** | 103 | iterative-pseudo-label-refinement, per-partition-variance-filtering, regularized-qda-classifier, transductive-train-test-transform |
...
| **llm** | 36 | binary-search-entity-narrowing, dual-role-agent-dispatch, answer-accumulation-filter, binary-answer-clamping |
