...
415 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **cv** | 125 | slice-as-channel-2d-cnn, modality-adaptive-dicom-windowing, middle-mip-std-volume-projection, lateralized-label-flip-tta-disable |
