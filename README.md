...
360 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **cv** | 100 | triple-stratified-shard-folds, dot-annotation-blob-diff-extraction, patch-grid-count-regression, multi-scale-patch-training-pyramid |
| **timeseries** | 43 | locale-scoped-holiday-flag, rolling-refit-arima-forecast, store-profile-hierarchical-clustering, neighbor-average-nan-interpolation |
| **llm** | 21 | wikipedia-rag-retrieval, kv-cache-prefix-scoring, counting-trap-adversarial-essay, weighted-attack-strategy-sampling |
