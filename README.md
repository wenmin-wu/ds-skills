...
515 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
|--------|-------|---------|
| **tabular** | 118 | game-state-grid-encoding, time-varying-reward-shaping, ppo-gym-wrapper-kaggle-env, phase-based-strategy-cycling |
