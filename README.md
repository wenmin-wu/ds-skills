...
370 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **cv** | 105 | two-stage-slice-localization-then-organ-crop, anisotropic-spacing-trilinear-resample, per-organ-multihead-sigmoid-softmax, per-patient-slice-maxpool-aggregation |
