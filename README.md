...
410 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **nlp** | 113 | two-stage-retrieve-rerank, multi-retriever-union-ensemble, length-sorted-batching, dropout-disabled-inference |
