...
335 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **cv** | 86 | arcface-metric-learning, deepsort-majority-vote-relabel, rotation-search-point-registration, iou-weighted-assignment-metric |
| **timeseries** | 36 | event-anchored-frame-sync, keystroke-pause-bucket-features, burst-rle-detection, multi-gap-lag-diff-features |
