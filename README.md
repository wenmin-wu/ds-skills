...
425 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **cv** | 130 | greedy-mask-overlap-resolution, per-class-score-threshold, map-iou-precision-sweep, detectron2-custom-data-mapper |
