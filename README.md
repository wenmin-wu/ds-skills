...
475 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
|--------|-------|---------|
| **tabular** | 104 | toroidal-manhattan-distance, iterative-pseudo-label-refinement, per-partition-variance-filtering, transductive-train-test-transform |
| **nlp** | 118 | taxonomy-context-enrichment, learned-attention-pooling, domain-special-token-embedding, anchor-grouped-validation |
