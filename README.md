...
450 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **cv** | 145 | structured-gt-serialization-tokens, tensor-core-aligned-padding, sigmoid-normalized-rmse, generative-output-numeric-cleaning |
