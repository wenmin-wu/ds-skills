...
530 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **cv** | 177 | video-frame-sampling-pipeline, centroid-distance-anomaly-score, cnn-rnn-video-classification, isotropic-resize-with-padding |
