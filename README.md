...
460 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **cv** | 155 | dual-view-reshape-forward, pairwise-distance-proximity-filter, bbox-interpolation-temporal-tracking, temporal-frame-jitter-augmentation |
