...
375 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **cv** | 110 | sparse-event-temporal-window-expansion, raft-optical-flow-extraction, cross-view-count-consistency-filter, efficientdet-headnet-swap |
