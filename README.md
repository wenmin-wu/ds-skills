...
485 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
|--------|-------|---------|
| **tabular** | 108 | multi-input-embedding-nn, brand-name-recovery-from-title, featureunion-field-dispatch, rmsle-keras-metric |
