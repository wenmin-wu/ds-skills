...
445 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **cv** | 140 | coverage-stratified-split, two-stage-bce-then-lovasz, metadata-injection-bottleneck, progressive-dropout-unet |
