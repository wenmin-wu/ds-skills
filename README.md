...
161 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **timeseries** | 27 | mc-dropout-uncertainty, flux-snr-weighted-features, multiband-lomb-scargle-period, unknown-class-residual-probability |
