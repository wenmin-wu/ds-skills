...
455 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **cv** | 150 | prediction-map-stitching-averaging, 3d-encoder-2d-decoder-segmentation, rotation-tta-segmentation, center-z-slice-selection |
