...
73 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **nlp** | 23 | deberta-classification, layerwise-lr-decay, transformer-lgbm-stacking, multisample-dropout |
| **cv** | 10 | mixed-precision-training, heavy-augmentation-pipeline, test-time-augmentation |
| **timeseries** | 5 | dilated-conv-residual-gru, event-peak-detection, prediction-smoothing-lpf |
