...
480 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **cv** | 160 | 3d-center-crop-zero-pad, per-modality-ensemble-averaging, black-slice-replacement, tumor-volume-ratio-features |
