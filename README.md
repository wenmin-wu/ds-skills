...
495 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **llm** | 45 | batched-perplexity-scoring, sliding-window-permutation-search, greedy-word-reinsert-search, stopword-priority-sorting |
