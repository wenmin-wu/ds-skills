...
505 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **cv** | 165 | brovey-pansharpening, spectral-index-segmentation, mask-to-polygon-contour-hierarchy, percentile-contrast-stretch |
| **timeseries** | 58 | ratio-target-for-smape, expanding-window-stacking, density-to-count-roundtrip, retroactive-outlier-rescaling |
