...
520 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
|--------|-------|---------|
| **tabular** | 120 | chained-target-prediction, season-phase-labeling, game-state-grid-encoding, ppo-gym-wrapper-kaggle-env |
| **nlp** | 119 | lda-topic-modeling, taxonomy-context-enrichment, learned-attention-pooling, domain-special-token-embedding |
| **cv** | 170 | clip-interrogator-captioning, embedding-knn-regression, weighted-embedding-blending, classifier-free-guidance-diffusion |
