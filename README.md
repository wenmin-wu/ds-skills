...
395 reusable techniques across 5 domains, each extracted from top-voted Kaggle competition solutions. Every skill is a self-contained SKILL.md — ready to be loaded by Claude Code, Cursor, Codex, or any AI coding agent.
...
| **cv** | 120 | rgby-4channel-fluorescence-loader, per-class-soft-f1-threshold-fitting, differentiable-soft-f1-loss, multilabel-rare-class-image-oversampling |
